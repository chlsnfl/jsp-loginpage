...
<body>
	...
	<tr height = "50">
		...
		<td width = "350" align = "center"><input type = "text" name = "id" size = "20" placeholder="id 넣으세요"></td></tr>
	<tr height = "50">
	...
	<tr height = "50">
		...
		<td width = "350" align = "center"><input type = "password" name = "pass2" size = "20"></td>
	</tr>
	<tr height = "50">
	...
	<tr height = "50">
		...
		<td width = "350" align = "center">
		<select name = "job">
		<option vlaue= "교사"	>교사</option>		
		<option vlaue= "변호사">변호사</option>		
		<option vlaue= "검사"	>검사</option>		
		<option vlaue= "의사"	>의사</option>		
		</select></td>
	</tr>
	<tr height = "50">
